      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: "100%" }}
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="fixed top-0 right-0 h-full w-72 bg-white shadow-2xl z-50 p-6 overflow-y-auto"
          >
            <div className="flex flex-col gap-4">
              {menuItems.map((item, index) => (
                <div key={index}>
              ...
              {/* Mobile Buttons */}
              <div className="mt-6 flex flex-col gap-3">
                <button className="w-full text-sm font-medium text-slate-700 hover:text-yellow-500 transition">
                  Login
                </button>
                <button className="w-full px-4 py-2 text-sm border border-slate-300 rounded-full hover:border-yellow-500 hover:text-yellow-500 transition">
                  Request a demo
                </button>
                <button className="w-full px-5 py-2 text-sm text-white bg-yellow-500 rounded-full hover:bg-yellow-600 transition">
                  Sign up
                </button>
              </div>
            </div>
