...
const menuGroups = [
  {
    title: "OVERVIEW",
    items: [
      { name: "Dashboard", icon: LayoutDashboard, path: "/subadmin" },
      { name: "Analytics", icon: BarChart, path: "/subadmin/analytics" },
    ]
  },

  {
    ...
    items: [
      { name: "Students", icon: Users, path: "/subadmin/students" },
      { name: "Teachers", icon: UserCheck, path: "/subadmin/teachers" },
    ]
  },

  {
    ...
    items: [
      { name: "Courses", icon: BookOpen, path: "/subadmin/courses" },
      { name: "Course Approvals", icon: FileCheck, path: "/subadmin/course-approval" },
      { name: "Assignments", icon: ClipboardList, path: "/subadmin/assignments" },
    ]
  },

  {
    ...
    items: [
      { name: "Live Classes", icon: Video, path: "/subadmin/live-classes" },
    ]
  },

  {
    title: "SYSTEM",
    items: [
      { name: "Announcements", icon: Bell, path: "/subadmin/announcements" },
      { name: "Settings", icon: Settings, path: "/subadmin/settings" },
      { name: "profile", icon: Users, path: "/subadmin/profile" },
    ]
  }
];
